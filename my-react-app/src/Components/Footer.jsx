  ...
  return (
    <div
      className={`w-auto bg-black ${
        Absolute ? "absolute" : ""
      } inset-x-0 bottom-0 h-auto block`}
    >
      <div className="flex flex-row justify-center items-center">
        <div className="text-white basis-1/3 flex flex-col gap-1 break-all">
        ...
        <div className="text-white py-5 basis-1/3 flex justify-center">
          <div className="flex flex-col">
            ...
            <div className="font-extralight flex justify-center text-xs ">
              Copyright © AirWatch Inc.
            </div>
          </div>
        </div>
        <div className="text-white basis-1/3 flex justify-center break-all">
